...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_eventtweet', (
            ...
            ('send_after_approval', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    models = {
        ...
        'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 0, 0)'}),
        ...
        'main.eventtweet': {
            ...
            'send_after_approval': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
